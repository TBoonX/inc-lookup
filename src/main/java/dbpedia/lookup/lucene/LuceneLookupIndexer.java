...
import dbpedia.lookup.indexing.ILookupIndexer;
...
public class LuceneLookupIndexer implements ILookupIndexer {
	 ...
	 */
	public LuceneLookupIndexer(String filePath, int updateInterval, int cacheSize) {
	...
	public void indexField(String key, String resource, String text) throws IOException {
