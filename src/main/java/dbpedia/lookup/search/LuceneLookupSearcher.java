...
public class LuceneLookupSearcher implements ILookupSearcher {
	 ...
	 * @throws IOException
	 */
	public String search(String queryString, int maxHits) throws SolrServerException, ParseException, IOException {
		...
		TopDocs docs = searcher.search(scoreQuery, maxHits);
